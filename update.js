// scripts/updateFantasyData.js
import fs from "fs/promises";

const USERS = [2827, 3053, 3123, 3217, 3222, 3605, 4467, 8018, 11994, 83871, 84349, 241490];
...
for (const userId of USERS) {
  const res = await fetch(
    `https://dreamteam.sport5.co.il/api/UserTeam/GetUserAndTeam?seasonId=9&userId=${userId}`,
    {
      headers: {
...
console.log("fantasy-data.json updated");